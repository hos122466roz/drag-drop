...
import CoinCharity from "./coinCharity/CoinCharity";
          ...
          <div>
            <div className="flex items-center justify-center">
              ...
              <div className="pl-10 border-l-1  border-l-zinc-400  ">
                <Link
                  href={"/account"}
                  className="border-1 hover:text-red-800 py-1 px-2 rounded-[4px] flex items-center text-xl  gap-x-2.5 font-MorabbaMedium tracking-lightes"
                >
